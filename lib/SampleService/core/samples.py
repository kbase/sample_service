...
from SampleService.core.workspace import UPA, WS, DataUnitID
from SampleService.core.workspace import WorkspaceAccessType as _WorkspaceAccessType
...
class Samples:
    ...
    def _validate_metadata(self, sample: Sample, return_error_detail: bool = False):
        ...
        :params return_exception: default=False, whether to return all errors found as a
                list exceptions.
