...
The most recent release from the specified repo will be loaded. If pre-leases should also be included,
set the `metadata-validator-config-prerelease` config variable to 'true'. A direct file URL override can
...
say `GO_0099593`, at the provided url to ensure the suffix matches a legitimate ontology
