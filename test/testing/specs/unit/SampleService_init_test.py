...
# NB cannot do happy path tests as integration tests, since the class initializer
# does all sorts of things outside the scope of this code - fetching
# validation specs from afar, initializing the database.
